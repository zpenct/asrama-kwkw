...
<body>
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <!-- Floor and Room List -->
        <div class="mt-8">
            <h2 class="text-lg font-semibold text-gray-900">Kamar:</h2>
            @if ($floors->isEmpty())
                    ...
                    @foreach ($floors as $floor)
                        <div class="mb-6">
                            ...
                            <div class="flex gap-2">
                                ...
                                <p class="text-gray-500">Price: Rp{{ number_format($floor->price, 2) }}</p>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="relative z-10 mx-auto max-w-md">
                                            ...
                                            <div class="pt-5 text-base font-semibold leading-7">
                                                <p>
                                                    <a href="#"
                                                        class="text-blue-500 transition-all duration-300 group-hover:text-white">Read
                                                        Book Now
                                                        &rarr;
                                                    </a>
                                                </p>
